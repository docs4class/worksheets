...
---
```{r, echo=F}
knitr::include_graphics(rep("images/pclogo.png", 1))
```
...
A definition of all variables is given in the [Data dictionary] section at the end, though you don't need to familiarize yourself with all variables in order to work through these exercises.  But understanding your data always helps.
