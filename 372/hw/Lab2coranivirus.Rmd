---
title: "Lab 2: Cumulative deaths from COVID-19"
output: html_document
---

## Introduction

In this lab we work with visualization, data wrangling, and dates.  Yeah!  Analytics 2 is *SO MUCH FUN!*

As you know, countries around the world are responding to an outbreak of respiratory illness caused by a novel coronavirus, COVID-19.
...
> For your ease of use, I have placed data on brightspace that you may use for this assignent, but you can grab more current data from the source above, if you like.

For our analysis, in addition to the coronavirus package, I may* use the following packages for data wrangling and visualization. You are only required to use `tidyverse` for data wrangling and visualization and package `lubridate` for handling dates
...
I make use of the **DT** package for interactive display of tabular output in the Appendix, but you may use another way to display your results.
...
1. Select these countries to study:   "China", "France", "United Kingdom", "US", and "Turkey"

```{r select-countries, echo=FALSE}
countries <- c(
  "China",
  "France",
  "United Kingdom",
...
```{r prep-country-data, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r record-as-of-date, echo=FALSE}
...
```{r visualise, warning=FALSE, echo=FALSE}
...
1. Select these countries to study:   "China", "France", "United Kingdom", "US", and "Turkey" and try to dupliate or improve upon the figure above.

2. Make an additional visualization that shows these countries' cumulative death toll stating with February 1, 2020. 
3. Make some sort of informative, well-formatted table.  One example is below though yours can be quite different.
